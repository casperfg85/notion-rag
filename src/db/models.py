...
class NotionPageSchema(BaseModel):
    ...
    text: str = Field(default="", description="Combined text content from page and all child blocks")
    ...
    vector: Optional[List[float]] = Field(None, description="Vector embedding for semantic search")
